        ...
        <div className="min-h-screen px-4 py-8 bg-gradient-to-br from-sky-100 to-pink-100 flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 flex flex-col gap-4">
                ...
                <motion.div
                    ...
                    className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 relative grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5 gap-5"
                >
                    {students.map((student) => (
                        <div
                            key={student._id}
                            className="bg-white p-4 rounded-xl shadow-md hover:shadow-xl transition border-t-2 border-pink-600 w-70 60% justify-self-center relative"
                        >
                            <img
                                src={student.studentImage || logo}
                                alt="Student"
                                className="w-full h-50 rounded-md mb-3 object-cover"
                            />
